...
class MailActivity(models.Model):
    ...
    <div style="color: #666666; border-left: 3px solid #ccc; padding-left: 10px;">
        <small><i>✅ Actividad finalizada por {self.env.user.name or 'Desconocido'} el {now_time}</i></small>
        <br/><small><b>Creada por:</b> {activity.create_uid.name or 'Desconocido'} el {create_time}</small>
    </div>
    """)
