...
class MailActivity(models.Model):
    ...
    def _action_done(self, feedback=False, attachment_ids=None):
        ...
        for activity in self:
            ...
            creator_info = f" por {activity.create_uid.name or 'Unknown'}" if activity.create_uid and activity.create_uid != self.env.user else ""
    ...
    <div style="color: #666666; border-left: 3px solid #ccc; padding-left: 10px;">
        ...
        <br/><small><b>Actividad fue creada{creator_info}:</b> {create_time}</small>
    </div>
    """)
